...
type LiveClassServiceClient interface {
	...
	// 加入直播课（双向流）
	JoinLiveClass(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[JoinLiveClassRequest, JoinLiveClassResponse], error)
	// 发送消息
...
func (c *liveClassServiceClient) JoinLiveClass(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[JoinLiveClassRequest, JoinLiveClassResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &LiveClassService_ServiceDesc.Streams[0], LiveClassService_JoinLiveClass_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[JoinLiveClassRequest, JoinLiveClassResponse]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type LiveClassService_JoinLiveClassClient = grpc.BidiStreamingClient[JoinLiveClassRequest, JoinLiveClassResponse]
...
func (c *liveClassServiceClient) GetAnswerStatistics(ctx context.Context, in *GetAnswerStatisticsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[AnswerStatistics], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &LiveClassService_ServiceDesc.Streams[1], LiveClassService_GetAnswerStatistics_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type LiveClassServiceServer interface {
	...
	// 加入直播课（双向流）
	JoinLiveClass(grpc.BidiStreamingServer[JoinLiveClassRequest, JoinLiveClassResponse]) error
	// 发送消息
...
func (UnimplementedLiveClassServiceServer) JoinLiveClass(grpc.BidiStreamingServer[JoinLiveClassRequest, JoinLiveClassResponse]) error {
	return status.Errorf(codes.Unimplemented, "method JoinLiveClass not implemented")
}
...
func _LiveClassService_JoinLiveClass_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(LiveClassServiceServer).JoinLiveClass(&grpc.GenericServerStream[JoinLiveClassRequest, JoinLiveClassResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type LiveClassService_JoinLiveClassServer = grpc.BidiStreamingServer[JoinLiveClassRequest, JoinLiveClassResponse]
